...
class Extractor:
    ...
    def __ex(self, website: str, output_file: str = None, yara: Optional[int] = None, classify: bool = False) -> SingleRes:
        """Scrapes the contents of the provided web address and outputs the 
    ...
    #    output,score,classify_verified = classify_text(url)
    #    return output,score,classify_verified
    #
    #def __classify(self, url: str) -> SingleRes:
    #    """Scrapes the contents of the provided web address and outputs the 
    #    contents to file or terminal.
#
    #    Args:
...
#
    ...
    #    result = []
    #    try:
    #        content = self.__session.get(url, allow_redirects=True, timeout=10).content
    #        output,score,classify_verified = self.classify_website(content)
    #        if classify_verified:
    #            result.append((logging.INFO, ("%s :: %s", url, output), False))
    #    except HTTPError as err:
    #        result.append((logging.DEBUG, ("Request Error :: %s", url), err))
    #    except (InvalidURL, URLError) as _:
    #        result.append((logging.DEBUG, ("Invalid URL Error :: %s :: Skipping...", url), False))
    #    except IncompleteRead as _:
    #        result.append((logging.DEBUG, ("Incomplete Read Error :: %s", url), False))
    #    except IOError as err:
    #        result.append((logging.DEBUG, ("IOError Error :: %s", url), err))
    #    except Exception as err:
    #        result.append((logging.DEBUG, ("Error :: %s", url), err))
#
    #    return result
    #
    #